...
public class SSAFYResourceService {
	...
	ArrayList<SSAFYResource> list = new ArrayList<>();
	/*
...
//	public void ssafyManage(Manager m) {}
	...
	public void addSSAFY(SSAFYResource r)  {
//		for(SSAFYResource ssafy : list) {
//			if(r.getName().equals(ssafy.getName())) {
//				try {
//					throw new DuplicateNameException(r.getName() + "회원님은 이미 등록된 상태");
...
//		list.add(r);
		...
		if(find == false) list.add(r);
		
	}
	
	public ArrayList<SSAFYResource> getAllMember(){
		return list;
	}
