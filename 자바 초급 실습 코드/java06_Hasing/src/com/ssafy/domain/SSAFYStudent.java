...
public class SSAFYStudent {
	...
	String name; //얘네는 클래스 데이터 타입임 앞글자가 대문자인 애들은 모두 초기값이 null임
	MyDate birthday; //왜 오류? 클래스가 없어서 : MyDate cannot be resolved to a type 이게 클래스 없다는 오류
...
//	}
	...
	char color; //'\u0000' //한문자가 들어갈 만큼의 공백을 뜻하는 값임 유니코드임
	int javaScore;
	int algoScore;
	int classroom;
