...
public class EmployeeUI implements UI {
	Scanner scanner;
	EmployeeManagerImpl manager;
	
	public EmployeeUI() {
		 scanner = new Scanner(System.in);
		 manager = EmployeeManagerImpl.getInstance();
	...
	public void insertEmployee() {
		...
		System.out.println("===================================");
		System.out.println("         [ SSAFY 직원 등록  ]");
		System.out.println("===================================");
	...
	public void printMainMenu() {
		System.out.println("===================================");
		System.out.println("      [ SSAFY 자격증 관리 프로그램 ]");
		System.out.println("===================================");
